...
public class Mus {
  public static void main(String[] args) {
    ...
    Partie.Resultat resultat = partie.jouer(new Opposants(humain, Joueur.ordinateur("Ordinateur 1 ") , Joueur.ordinateur("Ordinateur 2 "), Joueur.ordinateur("Ordinateur 3 ")));
