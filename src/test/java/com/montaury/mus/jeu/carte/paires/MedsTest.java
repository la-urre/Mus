...
class MedsTest {
  ...
  void sont_meilleurs_qu_une_paire_simple() {
    ...
    boolean meilleureOuEgale = meds.estMeilleureOuEgaleA(new Simple(ValeurCarte.ROI));
  ...
  void sont_moins_bons_que_des_doubles() {
    ...
    boolean meilleureOuEgale = meds.estMeilleureOuEgaleA(new Doubles(new Simple(ValeurCarte.AS), new Simple(ValeurCarte.AS)));
