...
class DoublesTest {
  ...
  void doivent_fournir_un_bonus_de_3() {
    Doubles doubles = new Doubles(new Simple(ValeurCarte.CINQ), new Simple(ValeurCarte.SIX));
  ...
  void sont_meilleurs_qu_une_paire_simple() {
    ...
    boolean meilleureOuEgale = doubles.estMeilleureOuEgaleA(new Simple(ValeurCarte.ROI));
  ...
  void sont_meilleures_que_des_doubles_dont_la_meilleure_paire_est_plus_petite() {
    ...
    boolean meilleureOuEgale = doubles.estMeilleureOuEgaleA(new Doubles(new Simple(ValeurCarte.DEUX), new Simple(ValeurCarte.CINQ)));
  ...
  void sont_meilleures_que_des_doubles_dont_la_meilleure_paire_est_egale_mais_la_seconde_paire_est_plus_petite() {
    ...
    boolean meilleureOuEgale = doubles.estMeilleureOuEgaleA(new Doubles(new Simple(ValeurCarte.SIX), new Simple(ValeurCarte.QUATRE)));
  ...
  void sont_egale_si_les_deux_paires_des_doubles_sont_egales() {
    ...
    boolean meilleureOuEgale = doubles.estMeilleureOuEgaleA(new Doubles(new Simple(ValeurCarte.SIX), new Simple(ValeurCarte.CINQ)));
  ...
  void sont_moins_bonnes_si_la_plus_grande_paire_est_plus_petite() {
    ...
    boolean meilleureOuEgale = doubles.estMeilleureOuEgaleA(new Doubles(new Simple(ValeurCarte.SEPT), new Simple(ValeurCarte.QUATRE)));
  ...
  void sont_moins_bonnes_si_la_plus_grande_paire_est_egale_mais_la_seconde_est_plus_petite() {
    Doubles doubles = new Doubles(new Simple(ValeurCarte.TROIS), new Simple(ValeurCarte.SIX));
