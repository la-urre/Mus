...
class PairesTest {
  @Test
  void ne_doit_pas_se_derouler_si_une_seule_equipe_a_des_paires() {
    Joueur joueurEsku = unJoueurAvec(main(Carte.DEUX_PIECE, Carte.CINQ_PIECE, Carte.SEPT_BATON, Carte.SEPT_COUPE));
